 ...
 */
public class MyFractalFantasiesDraft extends JFrame implements GLEventListener, KeyListener
{
    GLJPanel canvas;
    GL2 gl;
    GLU glu;
    ...
    {
        new MyFractalFantasiesDraft().run();
    }

    public MyFractalFantasiesDraft()
    {
